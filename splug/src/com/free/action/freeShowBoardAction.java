...
public class freeShowBoardAction implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response)
		...
		if(login == null ){
			...
			url = "/free/freeboardView.jsp";
		}
		
		String num = request.getParameter("num");
		BoardDAO bDao = BoardDAO.getInstance();
		bDao.updateReadCount(num,"freeboard");
		BoardVO bVo = bDao.selectOneBoardByNum(num,"freeboard");
		...
		List<DatVO> datList = Dao.selectBoardDats("freedat", num);
