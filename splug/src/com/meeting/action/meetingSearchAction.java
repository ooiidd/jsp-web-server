...
public class meetingSearchAction implements Action{
	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response)
		...
		List<BoardVO> boardList = bDao.selectSearchBoards("meetingboard",option,text);
		...
		if(login == null ){
			...
			url = "/meeting/meetingboardSearchList.jsp";
		}
