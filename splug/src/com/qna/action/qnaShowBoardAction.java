...
public class qnaShowBoardAction implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response)
		...
		if(login == null ){
			...
			url = "/qna/qnaboardView.jsp";
		}
		
		String num = request.getParameter("num");
		BoardDAO bDao = BoardDAO.getInstance();
		bDao.updateReadCount(num,"qnaboard");
		BoardVO bVo = bDao.selectOneBoardByNum(num,"qnaboard");
