...
public class suggestSearchAction implements Action{
	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response)
		...
		List<BoardVO> boardList = bDao.selectSearchBoards("suggestboard",option,text);
		...
		if(login == null ){
			...
			url = "/suggest/suggestboardSearchList.jsp";
		}
