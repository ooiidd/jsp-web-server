...
public class suggestBoardWriteAction implements Action {
	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response)
		...
		bDao.insertBoard(bVo,"suggestboard");
		
		response.sendRedirect("/splug/Superser?command=suggestboardList&page=1");
