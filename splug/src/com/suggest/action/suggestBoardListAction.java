...
public class suggestBoardListAction implements Action{
	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response)
		...
		List<BoardVO> boardList = bDao.selectPartBoards("suggestboard",(t-1)*15+1,t*15);
		request.setAttribute("boardList", boardList);
		request.setAttribute("nowpage", t);
		int tablenum=bDao.tableNumber("suggestboard");
		...
		if(login == null ){
			...
			url = "/suggest/suggestboardList.jsp";
		}
