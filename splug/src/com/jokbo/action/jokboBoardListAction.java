...
public class jokboBoardListAction implements Action{
	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response)
		...
		List<imgBoardVO> boardList = bDao.selectPartBoards("jokboboard",(t-1)*15+1,t*15);
		request.setAttribute("boardList", boardList);
		request.setAttribute("nowpage", t);
		int tablenum=bDao.tableNumber("jokboboard");
