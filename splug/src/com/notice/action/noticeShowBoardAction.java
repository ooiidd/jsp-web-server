...
public class noticeShowBoardAction implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response)
		...
		if(login == null ){
			...
			url = "/notice/noticeboardView.jsp";
		}
		
		String num = request.getParameter("num");
		BoardDAO bDao = BoardDAO.getInstance();
		bDao.updateReadCount(num,"noticeboard");
		BoardVO bVo = bDao.selectOneBoardByNum(num,"noticeboard");
		...
		List<DatVO> datList = Dao.selectBoardDats("noticedat", num);
