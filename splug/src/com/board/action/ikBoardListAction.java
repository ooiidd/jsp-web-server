...
public class ikBoardListAction implements Action{
	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response)
		...
		List<BoardVO> boardList = bDao.selectPartBoards("ikboard",(t-1)*15+1,t*15);
		request.setAttribute("boardList", boardList);
		request.setAttribute("nowpage", t);
		int tablenum=bDao.tableNumber("ikboard");
