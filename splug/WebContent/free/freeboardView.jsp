  ...
  <section>
  	<div id="wrap" align="center">
		...
		<form name="frm" action="ik.do" method="post">
			<input type="hidden" name="command" value="freedat_write">
			<input type="hidden" name="num" value="${board.num }">
			<input type="hidden" name="table" value="free">
			<table>
				<tr>
					<th>댓글쓰기</th>
		...
		<input type="button" value="게시글 수정"
			onclick="location.href='ik.do?command=freeboard_update_form&num=${board.num}'">
		<form name="deleteform" action="ik.do" method="post">
			<input type="hidden" name="command" value="freeboard_delete">
			<input type="hidden" name="num" value="${board.num }">
