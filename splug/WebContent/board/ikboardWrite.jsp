  ...
  <section>
	...
	<div id="wrap" align="center">
		<form name="frm" method="post" action="ik.do">
			<input type="hidden" name="command" value="ik_write">
			<table>
				<tr>
					<th>제목</th>
					<td><input type="text" size="70" name="title" onKeyUp="checkbyte(this,'title','150')"></td>
					<td><span id="title">0</span>/150Byte</td>
				</tr>
				<tr>
					<th>내용</th>
					<td><textarea cols="70" rows="15" name="content" onKeyUp="checkbyte(this,'content','1000')"></textarea></td>
					<td><span id="content">0</span>/1000Byte</td>
				</tr>
			</table>
			<br>
