...
<body>
 <header>
  ...
  <section>
  	<form action="ik.do" method="post" name="frm">
		...
		<table>
			...
			<tr>
				<td>아이디</td>
				<td><input type="text" name="userid" size="20" id="userid" value="${member.userid }" readonly></td>
			</tr>
			<tr>
				<td>암호</td>
			...
			<tr>
				<td>학번</td>
				<td><input type="text" name="hakbun" size="20" value="${member.hakbun }"></td>
			</tr>
			<tr>
				<td>핸드폰 번호</td>
